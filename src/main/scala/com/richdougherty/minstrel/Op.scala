...
object Op {
  ...
  val U8Store = Op(42, "u8store", Some(">u8"))
  val U8Load = Op(43, "u8load", Some("u8>"))
  val I8Store = Op(44, "i8store", Some(">i8"))
  val I8Load = Op(45, "i8load", Some("i8>"))
  val I16Store = Op(46, "i16store", Some(">i16"))
  val I16Load = Op(47, "i16load", Some("i16>"))
  val I32Store = Op(48, "i32store", Some(">i32"))
  val I32Load = Op(49, "i32load", Some("i32>"))
  val F32Store = Op(50, "f32store", Some(">f32"))
  val F32Load = Op(51, "f32load", Some("f32>"))
  val F64Store = Op(52, "f64store", Some(">f64"))
  val F64Load = Op(53, "f64load", Some("f64>"))

  val all = Seq(Halt, Push, Pop, Dup, Rot, Ret, Jmp, Call, If, Neg, Bnot, Not, Add, Sub, Mul, Div, Mod, Bor, Band, Bxor, Shl, Sshr, Zshr, Lt, Lte, Gt, Gte, Eq, Ne, Acos, Atan, Cos, Sin, Tan, Ceil, Floor, Exp, Log, Sqrt, Abs, Atan2, Imul, U8Store, U8Load, I8Store, I8Load, I16Store, I16Load, I32Store, I32Load, F32Store, F32Load, F64Store, F64Load)
