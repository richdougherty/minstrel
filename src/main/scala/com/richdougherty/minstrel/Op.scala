...
object Op {
  ...
  val In_Size = Op(58, "in_size", Some("in?"))
  val In_Wait = Op(59, "in_wait", Some("in..."))
  val In_Read = Op(60, "in_read", Some("in>"))
  val Out_Write = Op(61, "out_write", Some(">out"))

  val all = Seq(Halt, Push, Pop, Dup, Rot, Ret, Jmp, Call, If, Neg, Bnot, Not, Add, Sub, Mul, Div, Mod, Bor, Band, Bxor, Shl, Sshr, Zshr, Lt, Lte, Gt, Gte, Eq, Ne, Acos, Atan, Cos, Sin, Tan, Ceil, Floor, Exp, Log, Sqrt, Abs, Atan2, Imul, I8Store, I8Load, U8Store, U8Load, I16Store, I16Load, U16Store, U16Load, I32Store, I32Load, U32Store, U32Load, F32Store, F32Load, F64Store, F64Load, In_Size, In_Wait, In_Read, Out_Write)
